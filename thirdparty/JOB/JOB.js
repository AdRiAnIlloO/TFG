...
JOB = {
	...
	DecoderWorker : null, // A new Worker is assigned later with a safety check.
	OrientationCallback : null,
	// Always call the Init().
	Init : function(decoderWorker, exifSrc) {
		if (typeof(decoderWorker) === "object") {
			this.DecoderWorker = decoderWorker;
		}
		...
		script.src  = (typeof(exifSrc) === "string") ? exifSrc : "exif.js";
...
// Safely initialize the DecoderWorker, compatibilizing cross-origin execution:
try {
	JOB.DecoderWorker = new Worker("DecoderWorker.js");
} catch(error) {
